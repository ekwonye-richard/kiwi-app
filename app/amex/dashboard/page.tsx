...
import AmexDashboard from "@/components/AmexDashboard";
import {
...
export default function AmexDashboardPage() {
  ...
  if (accounts.length === 0) {
    return (
      <main>
        ...
        <Link href="/amex">Back to Amex import</Link>
      </main>
    );
  }

  return <AmexDashboard accounts={accounts} dateRange={dateRange} />;
}
